...
export const Features = () => {
  ...
  return (
    <>
      <div className="bg-black p-6">
        ...
        <div className="grid grid-cols-2 gap-3 mt-6">
          <Card className="bg-transparent text-gray-500 border-gray-800 border-2 rounded-none">
            ...
            <CardContent>
              <div className="flex space-x-1 items-center mb-3">
                <img src="/icons/dollar.svg" className="h-12 w-12 bg-blue-400 p-2 rounded-sm" />
                <img src="/icons/double-arrow.svg" className="h-10 w-10 bg-gray-100 " />
                <img src="/icons/euro.svg" className="h-12 w-12 bg-blue-400 p-2 rounded-sm " />
              </div>
          ...
          <Card className="bg-transparent text-gray-500 border-gray-800 border-2 rounded-none">
            ...
            <CardContent>
              <img src="/icons/token.svg" className="h-12 w-12 bg-blue-400 p-2 rounded-sm  ml-1 mb-3" />
          ...
          <Card className="bg-transparent text-gray-500 border-gray-800 border-2 rounded-none">
            ...
            <CardContent>
              <img src="/icons/swap.svg" className="h-12 w-12 bg-blue-400 p-2 rounded-sm  ml-1 mb-3" />
          ...
          <Card className="bg-transparent text-gray-500 border-gray-800 border-2 rounded-none">
            ...
            <CardContent>
              <img src="/icons/faucet.svg" className="h-12 w-12 bg-blue-400 p-2 rounded-sm  ml-1 mb-3" />
          ...
          <Card className="bg-transparent text-gray-500 border-gray-800 border-2 rounded-none">
            ...
            <CardContent>
              <img src="/icons/donation.svg" className="h-12 w-12 bg-blue-400 p-2 rounded-sm  ml-1 mb-3" />
          ...
          <Card className="bg-transparent text-gray-500 border-gray-800 border-2 rounded-none">
            ...
            <CardContent>
              <img src="/icons/payment.svg" className="h-12 w-12 bg-blue-400 p-2 rounded-sm  ml-1 mb-3" />
      ...
      <Card className="mt-6 py-8 mb-6 bg-gradient-to-b from-blue-300 to-blue-50">
